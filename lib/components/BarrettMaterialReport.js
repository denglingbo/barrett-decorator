...
export default function BarrettMaterialReport(params, event, filterFn) {
    if (params === void 0) { params = {}; }
    if (event === void 0) { event = 'click_material'; }
